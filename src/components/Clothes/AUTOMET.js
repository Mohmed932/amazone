...
import "../../App.css";
import AUTOMET from "../../Prodects//Clothes/AUTOMET.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {AUTOMET.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() => (count === 4 ? SetCount(AUTOMET.length) : SetCount(4))}

...
import "../../App.css";
import JUSTTOP from "../../Prodects/Automotive/JUSTTOP.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {JUSTTOP.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() => (count === 4 ? SetCount(JUSTTOP.length) : SetCount(4))}

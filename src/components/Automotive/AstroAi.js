...
import "../../App.css";
import AstroAi from "../../Prodects/Automotive/AstroAi.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {AstroAi.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() => (count === 4 ? SetCount(AstroAi.length) : SetCount(4))}

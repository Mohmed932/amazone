...
import "../../App.css";
import Febreze from "../../Prodects/Automotive/Febreze.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {Febreze.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() => (count === 4 ? SetCount(Febreze.length) : SetCount(4))}

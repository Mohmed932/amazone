...
import "../../App.css";
import ApplePhone from "../../Prodects/SmartPhone/Apple.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {ApplePhone.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() =>
          count === 4 ? SetCount(ApplePhone.length) : SetCount(4)
        }

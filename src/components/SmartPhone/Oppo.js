...
import "../../App.css";
import OppoPhone from "../../Prodects/SmartPhone/Oppo.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {OppoPhone.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() => (count === 4 ? SetCount(OppoPhone.length) : SetCount(4))}

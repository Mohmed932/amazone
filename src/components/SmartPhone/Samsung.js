...
import "../../App.css";
import SamsungPhone from "../../Prodects/SmartPhone/Samsung.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {SamsungPhone.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() =>
          count === 4 ? SetCount(SamsungPhone.length) : SetCount(4)
        }

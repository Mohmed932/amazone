...
import "../../App.css";
import SOLDEJANEIRO from "../../Prodects/Fragrances/SOLDEJANEIRO.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {SOLDEJANEIRO.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() =>
          count === 4 ? SetCount(SOLDEJANEIRO.length) : SetCount(4)
        }

...
import "../../App.css";
import Crocs from "../../Prodects/Shoes/Crocs.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {Crocs.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() => (count === 4 ? SetCount(Crocs.length) : SetCount(4))}

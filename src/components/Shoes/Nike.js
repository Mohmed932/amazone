...
import "../../App.css";
import Nike from "../../Prodects/Shoes/Nike.json";
  ...
  return (
    <div className="Phones">
      ...
      <div className="Phones_prodects">
        {Nike.slice(0, count).map(({ title, asin, thumbnailImage }) => (
      ...
      <button
        onClick={() => (count === 4 ? SetCount(Nike.length) : SetCount(4))}
